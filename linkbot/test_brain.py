...
# 포함 fast-path 길이비 게이트 — 짧은 일반명이 긴 특정작업에 우연히 포함될 때 자동병합 금지
check("match 일반명 우연포함 기각",
      _pc(["청백가요대전 청팀 콰르텟팀 오리지널 의상"], "카조에님 오리지널 의상") is None,
      _pc(["청백가요대전 청팀 콰르텟팀 오리지널 의상"], "카조에님 오리지널 의상"))
check("match 정당한 포함은 병합", _pc(["작캠용 바디 수정 도움"], "바디수정") == 0,
      _pc(["작캠용 바디 수정 도움"], "바디수정"))
